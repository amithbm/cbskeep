...
class ShadowDrawableWrapper extends DrawableWrapper
{
  ...
  {
    super(paramDrawable);
    mShadowStartColor = paramResources.getColor(R.color.shadow_start_color);
    mShadowMiddleColor = paramResources.getColor(R.color.shadow_mid_color);
    mShadowEndColor = paramResources.getColor(R.color.shadow_end_color);
  ...
  private void buildComponents(Rect paramRect)
  {
    ...
    mContentBounds.set(paramRect.left + mRawMaxShadowSize, paramRect.top + f, paramRect.right - mRawMaxShadowSize, paramRect.bottom - f);
