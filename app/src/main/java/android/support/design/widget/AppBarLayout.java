...
public class AppBarLayout extends LinearLayout
{
  ...
  final int getDownNestedPreScrollRange()
  {
    ...
    if (j >= 0)
    {
      ...
      if (ViewCompat.isLaidOut(localView))
      {
        ...
        label57: int m = localLayoutParams.mScrollFlags;
        if ((m & 0x5) != 5)
          break label113;
        if ((m & 0x8) == 0)
          break label106;
  ...
  public final int getTotalScrollRange()
  {
    ...
    if (j < n)
    {
      ...
      label63: int i1 = localLayoutParams.mScrollFlags;
      k = i;
      if ((i1 & 0x1) != 0)
      {
        i += m;
    ...
    for (i = mLastInsets.getSystemWindowInsetTop(); ; i = 0)
    {
      ...
      mTotalScrollRange = i;
      return i;
      label125: m = localView.getMeasuredHeight();
      break label63;
      label135: j += 1;
      break;
    }
  ...
  public static class Behavior extends ViewOffsetBehavior<AppBarLayout>
  {
    ...
    public boolean onLayoutChild(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout, int paramInt)
    {
      ...
      while (true)
      {
        ...
        return bool;
        label64: paramInt += Math.round(paramCoordinatorLayout.getHeight() * mOffsetToChildIndexOnLayoutPerc);
      }
    }
    ...
    public void onRestoreInstanceState(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout, Parcelable paramParcelable)
    {
      if ((paramParcelable instanceof SavedState))
      {
        ...
        mOffsetToChildIndexOnLayout = paramParcelable.firstVisibleChildIndex;
        mOffsetToChildIndexOnLayoutPerc = paramParcelable.firstVisibileChildPercentageShown;
        mOffsetToChildIndexOnLayoutIsMinHeight = paramParcelable.firstVisibileChildAtMinimumHeight;
        return;
      }
    ...
    {
      return setAppBarTopBottomOffset(paramCoordinatorLayout, paramAppBarLayout, paramInt, -2147483648, 2147483647);
    }
    ...
    final int setAppBarTopBottomOffset(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout, int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      label123: for (paramInt1 = interpolateOffset(paramAppBarLayout, paramInt2); ; paramInt1 = paramInt2)
      {
      ...
      implements Runnable
    {
      ...
      FlingRunnable(CoordinatorLayout paramAppBarLayout, AppBarLayout arg3)
      {
        mParent = paramAppBarLayout;
        Object localObject;
        mLayout = localObject;
      }
