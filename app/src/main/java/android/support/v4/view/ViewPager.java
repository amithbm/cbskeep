...
public class ViewPager extends ViewGroup
{
  ...
  private void calculatePageOffsets(ItemInfo paramItemInfo1, int paramInt, ItemInfo paramItemInfo2)
  {
    ...
    else
    {
      while (true)
      {
        if ((i > paramItemInfo1.position) || (j >= mItems.size()))
          break label409;
    ...
    label603: float f1 = paramItemInfo1.offset + paramItemInfo1.widthFactor + f2;
    i = paramItemInfo1.position + 1;
    int j = paramInt + 1;
    paramInt = i;
    i = j;
    while (i < k)
    {
      ...
      if (paramItemInfo1.position == m - 1)
        mLastOffset = (paramItemInfo1.widthFactor + f1 - 1.0F);
      ...
      if (i < mItems.size())
      {
        ...
        if (j == 0)
        {
          ...
          if (((ItemInfo)localObject3).position != k + 1)
          {
            ...
            ((ItemInfo)localObject1).widthFactor = mAdapter.getPageWidth(((ItemInfo)localObject1).position);
            m = i - 1;
          }
        }
  ...
  private boolean performDrag(float paramFloat)
  {
    ...
    if (localItemInfo2.position != mAdapter.getCount() - 1)
    {
      j = 0;
  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt2 > 0) && (!mItems.isEmpty()))
    {
      ...
      if (!mScroller.isFinished())
      {
        ...
        mScroller.startScroll(paramInt2, 0, (int)(localItemInfo.offset * paramInt1), 0, paramInt3 - paramInt4);
      }
      return;
    }
    ItemInfo localItemInfo = infoForPosition(mCurItem);
    if (localItemInfo != null);
    for (float f = Math.min(localItemInfo.offset, mLastOffset); ; f = 0.0F)
    {
  ...
  private void scrollToItem(int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    int i = 0;
    if (localItemInfo != null)
      i = (int)(getClientWidth() * Math.max(mFirstOffset, Math.min(localItemInfo.offset, mLastOffset)));
    if (paramBoolean1)
    {
    ...
    if (k != 393216)
    {
      ...
      while (i < getChildCount())
      {
        ...
        if (localView.getVisibility() == 0)
        {
          ...
          if ((localItemInfo != null) && (localItemInfo.position == mCurItem))
  ...
  ItemInfo addNewItem(int paramInt1, int paramInt2)
  {
    ...
    localItemInfo.object = mAdapter.instantiateItem(this, paramInt1);
    localItemInfo.widthFactor = mAdapter.getPageWidth(paramInt1);
  ...
  public boolean arrowScroll(int paramInt)
  {
    ...
    if (localView == this)
    {
      ...
      if (paramInt != 17)
        break label281;
      i = getChildRectInPagerCoordinates(mTempRect, localView).left;
      j = getChildRectInPagerCoordinates(mTempRect, (View)localObject).left;
    ...
    while (true)
    {
      ...
      localObject = null;
      break;
      label271: bool = localView.requestFocus();
      continue;
      label281: if (paramInt == 66)
      {
        i = getChildRectInPagerCoordinates(mTempRect, localView).left;
        j = getChildRectInPagerCoordinates(mTempRect, (View)localObject).left;
        if ((localObject != null) && (i <= j))
        ...
        else
        {
          ...
          continue;
          label344: if ((paramInt == 17) || (paramInt == 1))
            bool = pageLeft();
  ...
  void dataSetChanged()
  {
    ...
    if ((mItems.size() < mOffscreenPageLimit * 2 + 1) && (mItems.size() < i4))
    {
      ...
      i3 = mAdapter.getItemPosition(((ItemInfo)localObject).object);
      if (i3 != -1)
        break label133;
      n = j;
      i1 = k;
    ...
    while (true)
    {
      ...
      label133: if (i3 == -2)
      {
        ...
        mAdapter.destroyItem(this, ((ItemInfo)localObject).position, ((ItemInfo)localObject).object);
        i = 1;
        i2 = i3;
        i1 = m;
        n = j;
        if (mCurItem == ((ItemInfo)localObject).position)
        {
      ...
      else
      {
        ...
        {
          if (((ItemInfo)localObject).position == mCurItem)
            j = i3;
  ...
  public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    while (i < j)
    {
      ...
      {
        ItemInfo localItemInfo = infoForChild(localView);
        if ((localItemInfo != null) && (localItemInfo.position == mCurItem) && (localView.dispatchPopulateAccessibilityEvent(paramAccessibilityEvent)))
          return true;
      }
      i += 1;
    }
  ...
  protected int getChildDrawingOrder(int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = paramInt1 - 1 - paramInt2; ; paramInt1 = paramInt2)
      return ((LayoutParams)((View)mDrawingOrderedChildren.get(paramInt1)).getLayoutParams()).childIndex;
  }
  ...
  ItemInfo infoForChild(View paramView)
  {
    ...
    {
      ItemInfo localItemInfo = (ItemInfo)mItems.get(i);
      if (mAdapter.isViewFromObject(paramView, localItemInfo.object))
        return localItemInfo;
      i += 1;
    }
    return null;
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((mPageMargin > 0) && (mMarginDrawable != null) && (mItems.size() > 0) && (mAdapter != null))
    {
      ...
      i1 = ((ItemInfo)mItems.get(n - 1)).position;
    }
    while (true)
    {
      float f2;
    ...
    while (paramInt2 < i)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if ((localLayoutParams == null) || (!localLayoutParams.isDecor))
          localView.measure(View.MeasureSpec.makeMeasureSpec((int)(paramInt1 * localLayoutParams.widthFactor), 1073741824), mChildHeightMeasureSpec);
      }
      paramInt2 += 1;
    }
  }
  ...
  protected boolean onRequestFocusInDescendants(int paramInt, Rect paramRect)
  {
    ...
    while (i != j)
    {
      ...
      {
        ItemInfo localItemInfo = infoForChild(localView);
        if ((localItemInfo != null) && (localItemInfo.position == mCurItem) && (localView.requestFocus(paramInt, paramRect)))
        {
          return true;
          i = j - 1;
          k = -1;
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    if (mAdapter != null)
    {
      mAdapter.restoreState(paramParcelable.adapterState, paramParcelable.loader);
      setCurrentItemInternal(paramParcelable.position, false, true);
      return;
    }
    mRestoredCurItem = paramParcelable.position;
    mRestoredAdapterState = paramParcelable.adapterState;
    mRestoredClassLoader = paramParcelable.loader;
  }

  public Parcelable onSaveInstanceState()
  {
    SavedState localSavedState = new SavedState(super.onSaveInstanceState());
    localSavedState.position = mCurItem;
    if (mAdapter != null)
      localSavedState.adapterState = mAdapter.saveState();
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      Object localObject;
      label382: for (f1 = mInitialMotionX + mTouchSlop; ; f1 = mInitialMotionX - mTouchSlop)
      {
        mLastMotionX = f1;
        mLastMotionY = f2;
        setScrollState(1);
      ...
      if (mIsBeingDragged)
      {
        ...
        setCurrentItemInternal(determineTargetPage(((ItemInfo)localObject).position, (n / m - ((ItemInfo)localObject).offset) / ((ItemInfo)localObject).widthFactor, j, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, mActivePointerId)) - mInitialMotionX)), true, true, j);
        mActivePointerId = -1;
        endDrag();
  ...
  void populate(int paramInt)
  {
    ...
    label389: label664: label677: label1325: label1331: 
    while (true)
    {
      return;
      i = 17;
      break;
      label64: if (mPopulatePending)
      {
        sortChildDrawingOrder();
        return;
      }
      if (getWindowToken() != null)
      {
        ...
        if (paramInt < mItems.size())
        {
          ...
          if (((ItemInfo)localObject4).position < mCurItem)
            break label664;
          localObject1 = localObject3;
          if (((ItemInfo)localObject4).position == mCurItem)
        ...
        label698: label955: label1084: label1215: for (localObject1 = ((ItemInfo)localObject3).object; ; localObject1 = null)
        {
          ...
          if (m == ((ItemInfo)localObject4).position)
          {
            ...
            {
              mItems.remove(n);
              mAdapter.destroyItem(this, m, ((ItemInfo)localObject4).object);
              i = n - 1;
              paramInt = k - 1;
              if (i < 0)
                break label825;
          ...
          label834: if ((localObject4 != null) && (m == ((ItemInfo)localObject4).position))
          {
          ...
          if (i == ((ItemInfo)localObject4).position)
          {
            ...
            {
              mItems.remove(m);
              mAdapter.destroyItem(this, i, ((ItemInfo)localObject4).object);
              if (m >= mItems.size())
                break label1084;
              localObject1 = (ItemInfo)mItems.get(m);
              paramInt = m;
          ...
          label1096: if ((localObject4 != null) && (i == ((ItemInfo)localObject4).position))
          {
            f1 = f3 + ((ItemInfo)localObject4).widthFactor;
            paramInt = m + 1;
            if (paramInt < mItems.size());
        ...
        label825: sortChildDrawingOrder();
        label949: if (hasFocus())
        {
          localObject1 = findFocus();
          if (localObject1 != null);
          for (localObject1 = infoForAnyChild((View)localObject1); ; localObject1 = null)
          {
            if ((localObject1 != null) && (((ItemInfo)localObject1).position == mCurItem))
              break label1331;
            paramInt = 0;
            while (true)
            {
              ...
              if ((localObject2 != null) && (((ItemInfo)localObject2).position == mCurItem) && (((View)localObject1).requestFocus(j)))
                break;
              paramInt += 1;
            }
            break;
  ...
  void setCurrentItemInternal(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      {
        ((ItemInfo)mItems.get(paramInt1)).scrolling = true;
        paramInt1 += 1;
      }
      i = paramInt1;
  ...
  public void setPageTransformer(boolean paramBoolean, PageTransformer paramPageTransformer)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      if (bool1 == bool2)
        break label87;
      i = 1;
      label37: mPageTransformer = paramPageTransformer;
    ...
    label75: label81: label87: label92: for (mDrawingOrder = j; ; mDrawingOrder = 0)
    {
      if (i != 0)
        populate();
      return;
