  ...
  implements NestedScrollingChild, NestedScrollingParent
{
  ...
  boolean overScrollByCompat(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, boolean paramBoolean)
  {
    ...
    int i;
    int j;
    label34: label53: label72: boolean bool;
    ...
    while (true)
    {
      ...
      label187: j = 0;
      break label72;
      label193: paramInt1 = paramInt3;
      if (paramInt3 >= paramInt2)
        break label131;
      paramInt1 = paramInt2;
      paramBoolean = true;
      break label131;
      label208: paramInt2 = paramInt4;
  ...
  public boolean pageScroll(int paramInt)
  {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label121: mTempRect.top = (getScrollY() - j);
      if (mTempRect.top < 0)
        mTempRect.top = 0;
    }
  }
