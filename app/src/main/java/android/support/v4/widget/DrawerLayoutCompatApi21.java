...
class DrawerLayoutCompatApi21
{
  ...
  public static void applyMarginInsets(ViewGroup.MarginLayoutParams paramMarginLayoutParams, Object paramObject, int paramInt)
  {
    ...
    while (true)
    {
      leftMargin = paramObject.getSystemWindowInsetLeft();
      topMargin = paramObject.getSystemWindowInsetTop();
      rightMargin = paramObject.getSystemWindowInsetRight();
      bottomMargin = paramObject.getSystemWindowInsetBottom();
      return;
