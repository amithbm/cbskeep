...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat
{
  ...
  private boolean intersectVisibleToUser(Rect paramRect)
  {
    ...
    do
    {
      do
        return false;
      while (mView.getWindowVisibility() != 0);
      for (localObject = mView.getParent(); ; localObject = ((View)localObject).getParent())
      {
    ...
    while ((localObject == null) || (!mView.getLocalVisibleRect(mTempVisibleRect)));
  ...
  public boolean dispatchHoverEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (mFocusedVirtualViewId == -2147483648);
  ...
  {
    if ((paramInt1 == -2147483648) || (!mManager.isEnabled()));
