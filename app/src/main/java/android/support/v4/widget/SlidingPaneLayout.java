...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    label53: for (View localView = getChildAt(1); ; localView = null)
    {
    ...
    label59: int k = localView.getTop();
  ...
  protected boolean drawChild(Canvas paramCanvas, View paramView, long paramLong)
  {
    ...
    boolean bool;
    if ((mCanSlide) && (!localLayoutParams.slideable) && (mSlideableView != null))
    {
    ...
    while (true)
    {
      ...
      break;
      label140: if ((localLayoutParams.dimWhenOffset) && (mSlideOffset > 0.0F))
      {
  ...
  boolean isDimmed(View paramView)
  {
    ...
    while ((!mCanSlide) || (!paramView.dimWhenOffset) || (mSlideOffset <= 0.0F));
    return true;
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int i;
    View localView;
    label148: label156: label165: for (float f = 1.0F; ; f = 0.0F)
    {
      mSlideOffset = f;
      i = 0;
      paramInt2 = paramInt1;
    ...
    if (localLayoutParams.slideable)
    {
      ...
      if (bool)
      {
        ...
        label255: if (paramInt2 + i + i2 + i1 / 2 <= k - paramInt3)
          break label380;
        paramBoolean = true;
        label277: localLayoutParams.dimWhenOffset = paramBoolean;
    ...
    while (true)
    {
      ...
      i = j;
      break label319;
      label428: i = paramInt2 - i;
      j = i + i1;
    }
    label444: if (mFirstLayout)
    {
      if (!mCanSlide)
        break label519;
      if (mParallaxBy != 0)
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label397: paramInt1 = localLayoutParams.leftMargin + localLayoutParams.rightMargin;
    if (localLayoutParams.width == -2)
    {
      paramInt1 = View.MeasureSpec.makeMeasureSpec(i3 - paramInt1, -2147483648);
      label430: if (localLayoutParams.height != -2)
        break label611;
      j = View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648);
      label449: localView.measure(paramInt1, j);
    ...
    label648: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      break label430;
      label611: if (localLayoutParams.height == -1)
      {
      ...
      if (j < i4)
      {
        ...
        while (true)
        {
          ...
          if (localView.getVisibility() != 8)
            ...
            {
              paramInt1 = 1;
              label751: if (paramInt1 != 0)
              {
                n = 0;
                label758: if ((!bool1) || (localView == mSlideableView))
                  break label901;
            ...
            else
            {
              while (true)
              {
                ...
                break label758;
                label851: if (localLayoutParams.height == -1)
                {
                ...
                else
                {
                  ...
                  continue;
                  label886: paramInt1 = View.MeasureSpec.makeMeasureSpec(localView.getMeasuredHeight(), 1073741824);
                }
              }
              if (localLayoutParams.weight > 0.0F)
              {
    ...
    label901: label1036: setMeasuredDimension(k, getPaddingTop() + i + getPaddingBottom());
    mCanSlide = bool1;
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    while (true)
    {
      mPreservedOpenState = paramParcelable.isOpen;
      return;
      closePane();
    }
  }
  ...
  boolean smoothSlideTo(float paramFloat, int paramInt)
  {
    ...
    while (true)
    {
      ...
      for (paramInt = (int)(getWidth() - (paramInt + i + mSlideRange * paramFloat + j)); mDragHelper.smoothSlideViewTo(mSlideableView, paramInt, mSlideableView.getTop()); paramInt = (int)(getPaddingLeft() + localLayoutParams.leftMargin + mSlideRange * paramFloat))
      {
  ...
  void updateObscuredViewsVisibility(View paramView)
  {
    ...
    while (true)
    {
      ...
      i = getPaddingLeft();
      break;
      label123: j = getWidth() - getPaddingRight();
      break label31;
      label136: k = 0;
      i1 = 0;
      n = 0;
    ...
    {
      i3 = j;
      label159: int i8 = Math.max(i3, localView.getLeft());
      int i9 = Math.max(i4, localView.getTop());
      if (!bool)
        break label271;
      i3 = i;
      label191: i3 = Math.min(i3, localView.getRight());
      int i10 = Math.min(i5 - i6, localView.getBottom());
      if ((i8 < m) || (i9 < i1) || (i3 > n) || (i10 > k))
        break label277;
    }
    label271: label277: for (int i3 = 4; ; i3 = 0)
    {
