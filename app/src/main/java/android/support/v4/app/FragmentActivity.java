...
public class FragmentActivity extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (localNonConfigurationInstances != null)
      mAllLoaderManagers = localNonConfigurationInstances.loaders;
    if (paramBundle != null)
    {
  ...
  void onReallyStop()
  {
    ...
    while (true)
    {
      ...
      return;
      label41: mLoaderManager.doRetain();
    }
  }
  ...
  public final Object onRetainNonConfigurationInstance()
  {
    ...
    if (mAllLoaderManagers != null)
    {
      ...
      if (j < m)
      {
        ...
        while (true)
        {
          ...
          mAllLoaderManagers.remove(localObject3.mWho);
        }
      }
    }
    ...
    ((NonConfigurationInstances)localObject2).loaders = mAllLoaderManagers;
    return localObject2;
  }
  ...
  protected void onStart()
  {
    ...
    while (true)
    {
      ...
      label143: if (!mCheckedForLoaderManager)
      {
