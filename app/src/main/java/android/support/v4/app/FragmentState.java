  ...
  implements Parcelable
{
  ...
  public FragmentState(Fragment paramFragment)
  {
    ...
    mIndex = paramFragment.mIndex;
    mFromLayout = paramFragment.mFromLayout;
    mFragmentId = paramFragment.mFragmentId;
    mContainerId = paramFragment.mContainerId;
    mTag = paramFragment.mTag;
    mRetainInstance = paramFragment.mRetainInstance;
    mDetached = paramFragment.mDetached;
    mArguments = paramFragment.mArguments;
  }
  ...
  public Fragment instantiate(FragmentActivity paramFragmentActivity, Fragment paramFragment)
  {
    ...
    mInstance.mFragmentManager = paramFragmentActivity.mFragments;
