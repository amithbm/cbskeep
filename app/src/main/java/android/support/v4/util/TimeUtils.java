  ...
  private static int formatDurationLocked(long paramLong, int paramInt)
  {
    ...
    if (paramLong > 0L)
    {
      ...
      if (j <= 0)
        break label328;
      bool = true;
      label201: j += accumField(i1, 1, bool, 2);
      if (j <= 0)
        break label334;
      bool = true;
      label223: j += accumField(i2, 1, bool, 2);
      if (j <= 0)
        break label340;
      bool = true;
      label245: k = j + accumField(m, 1, bool, 2);
      if (k <= 0)
        break label346;
    }
    label328: label334: label340: label346: for (int j = 3; ; j = 0)
    {
    ...
    if (paramInt != 0)
    {
      ...
      if (n == k)
        break label529;
      bool = true;
      label395: if (paramInt == 0)
        break label535;
      j = 2;
      label402: n = printField(arrayOfChar, i1, 'h', n, bool, j);
      if (n == k)
        break label541;
      bool = true;
      label429: if (paramInt == 0)
        break label547;
      j = 2;
      label436: n = printField(arrayOfChar, i2, 'm', n, bool, j);
      if (n == k)
        break label553;
      bool = true;
      label463: if (paramInt == 0)
        break label559;
      j = 2;
      label470: j = printField(arrayOfChar, m, 's', n, bool, j);
      if ((paramInt == 0) || (j == k))
        break label565;
    }
    label529: label535: label541: label547: label553: label559: label565: for (paramInt = 3; ; paramInt = 0)
    {
