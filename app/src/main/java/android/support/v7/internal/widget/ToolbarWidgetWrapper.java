  ...
  implements DecorToolbar
{
  ...
  public ToolbarWidgetWrapper(Toolbar paramToolbar, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (mTintManager = paramToolbar.getTintManager(); ; mTintManager = TintManager.get(paramToolbar.getContext()))
    {
      ...
      bool = false;
      break;
      label492: mDisplayOpts = detectDisplayOptions();
    }
  }
  ...
  private void updateNavigationIcon()
  {
    ...
    label32: for (Drawable localDrawable = mNavIcon; ; localDrawable = mDefaultNavigationIcon)
    {
  ...
  private void updateToolbarLogo()
  {
    ...
    while (true)
    {
      ...
      return;
      label41: localDrawable = mIcon;
      continue;
      label49: localDrawable = mIcon;
    }
  }
  ...
  public void setDisplayOptions(int paramInt)
  {
    ...
    while (true)
    {
      ...
      return;
      label115: mToolbar.setNavigationIcon(null);
      break;
      label126: mToolbar.setTitle(null);
      mToolbar.setSubtitle(null);
    }
    label145: mToolbar.removeView(mCustomView);
  }
