  ...
  implements ViewPropertyAnimatorListener
{
  ...
  private void initTitle()
  {
    ...
    label234: label239: for (int k = 0; ; k = 8)
    {
  ...
  {
    ViewCompat.setTranslationX(mClose, -mClose.getWidth() - ((ViewGroup.MarginLayoutParams)mClose.getLayoutParams()).leftMargin);
  ...
  {
    Object localObject = ViewCompat.animate(mClose).translationX(-mClose.getWidth() - ((ViewGroup.MarginLayoutParams)mClose.getLayoutParams()).leftMargin);
    ((ViewPropertyAnimatorCompat)localObject).setDuration(200L);
    ((ViewPropertyAnimatorCompat)localObject).setListener(this);
    ((ViewPropertyAnimatorCompat)localObject).setInterpolator(new DecelerateInterpolator());
    ViewPropertyAnimatorCompatSet localViewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
  ...
  public void initForMode(final ActionMode paramActionMode)
  {
    ...
    while (true)
    {
      ...
      addView(mClose);
      break;
      label192: mActionMenuPresenter.setWidthLimit(getContext().getResources().getDisplayMetrics().widthPixels, true);
      mActionMenuPresenter.setItemLimit(2147483647);
      localLayoutParams.width = -1;
      localLayoutParams.height = mContentHeight;
      paramActionMode.addMenuPresenter(mActionMenuPresenter, mPopupContext);
      mMenuView = ((ActionMenuView)mActionMenuPresenter.getMenuView(this));
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (mClose != null)
      {
        ...
        if (mClose.getVisibility() != 8)
        {
          ...
          label100: paramInt2 = next(i, paramInt2, paramBoolean);
    ...
    label297: label306: label316: label329: for (paramBoolean = true; ; paramBoolean = false)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int k;
    int j;
    label391: if (mContentHeight > 0)
    {
      i = mContentHeight;
      n = getPaddingTop() + getPaddingBottom();
      paramInt1 = m - getPaddingLeft() - getPaddingRight();
      k = i - n;
      j = View.MeasureSpec.makeMeasureSpec(k, -2147483648);
      paramInt2 = paramInt1;
      Object localObject;
      if (mClose != null)
      {
      ...
      if (mTitleLayout != null)
      {
        ...
        if (mCustomView == null)
        {
          ...
          if (j == 0)
            break label500;
          paramInt1 = 0;
          label322: ((LinearLayout)localObject).setVisibility(paramInt1);
        }
      }
      label328: if (mCustomView != null)
      {
        localObject = mCustomView.getLayoutParams();
        if (((ViewGroup.LayoutParams)localObject).width == -2)
          break label522;
        paramInt1 = 1073741824;
        label358: if (((ViewGroup.LayoutParams)localObject).width < 0)
          break label529;
        paramInt2 = Math.min(((ViewGroup.LayoutParams)localObject).width, paramInt2);
        label376: if (((ViewGroup.LayoutParams)localObject).height == -2)
          break label532;
        j = 1073741824;
    ...
    label522: label529: label532: label540: 
    while (true)
    {
      ...
      label494: j = 0;
      break label297;
      label500: paramInt1 = 8;
      break label322;
      label506: paramInt2 = measureChildView(mTitleLayout, paramInt1, j, 0);
      break label328;
    ...
    return;
    label551: setMeasuredDimension(m, i);
  }
