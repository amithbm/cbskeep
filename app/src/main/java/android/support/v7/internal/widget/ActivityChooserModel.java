...
public class ActivityChooserModel extends DataSetObservable
{
  ...
  public ResolveInfo getActivity(int paramInt)
  {
    ...
    {
      ensureConsistentState();
      ResolveInfo localResolveInfo = ((ActivityResolveInfo)mActivities.get(paramInt)).resolveInfo;
  ...
  public ResolveInfo getDefaultActivity()
  {
    synchronized (mInstanceLock)
    {
      ...
      {
        ResolveInfo localResolveInfo = ((ActivityResolveInfo)mActivities.get(0)).resolveInfo;
        return localResolveInfo;
      }
      return null;
    }
    ...
    implements Comparable<ActivityResolveInfo>
  {
    ...
    {
      Object localObject;
      resolveInfo = localObject;
    }

    public int compareTo(ActivityResolveInfo paramActivityResolveInfo)
    {
      return Float.floatToIntBits(paramActivityResolveInfo.weight) - Float.floatToIntBits(weight);
    }
    ...
    public boolean equals(Object paramObject)
    {
      ...
      while (Float.floatToIntBits(weight) == Float.floatToIntBits(paramObject.weight));
      return false;
    }
  ...
  public static final class HistoricalRecord
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      do
      {
        ...
        else if (!activity.equals(paramObject.activity))
          return false;
        if (time != paramObject.time)
          return false;
      }
      while (Float.floatToIntBits(weight) == Float.floatToIntBits(paramObject.weight));
      return false;
