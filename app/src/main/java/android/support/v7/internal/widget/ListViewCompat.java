...
public class ListViewCompat extends ListView
{
  ...
  protected void positionSelectorCompat(int paramInt, View paramView)
  {
    ...
    localRect.left -= mSelectionLeftPadding;
    localRect.top -= mSelectionTopPadding;
    localRect.right += mSelectionRightPadding;
    localRect.bottom += mSelectionBottomPadding;
    try
    {
  ...
  public void setSelector(Drawable paramDrawable)
  {
    ...
    for (Object localObject = new GateKeeperDrawable(paramDrawable); ; localObject = null)
    {
      ...
      mSelectionLeftPadding = ((Rect)localObject).left;
      mSelectionTopPadding = ((Rect)localObject).top;
      mSelectionRightPadding = ((Rect)localObject).right;
      mSelectionBottomPadding = ((Rect)localObject).bottom;
      return;
    }
  }
