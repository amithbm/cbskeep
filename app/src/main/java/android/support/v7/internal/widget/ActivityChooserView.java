...
public class ActivityChooserView extends ViewGroup
{
  ...
  private void showPopupUnchecked(int paramInt)
  {
    ...
    boolean bool;
    int i;
    label59: label90: ListPopupWindow localListPopupWindow;
    ...
    while (true)
    {
      ...
      label190: i = 0;
      break label59;
      label195: mAdapter.setShowFooterView(false);
      mAdapter.setMaxActivityCount(paramInt);
      break label90;
      label214: mAdapter.setShowDefaultActivity(false, false);
    }
  }
    ...
    implements View.OnClickListener, View.OnLongClickListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener
  {
    ...
    public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
    {
      ...
      default:
        throw new IllegalArgumentException();
      case 1:
        this$0.showPopupUnchecked(2147483647);
      case 0:
      }
      do
      {
