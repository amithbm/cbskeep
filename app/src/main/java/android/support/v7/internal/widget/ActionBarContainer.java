...
public class ActionBarContainer extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    while (true)
    {
      ...
      label136: bool = false;
      continue;
      label141: if ((mBackground != null) || (mStackedBackground != null))
        bool = false;
    }
  }
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      paramInt1 = 1;
      break;
      label249: if ((mContextView != null) && (mContextView.getVisibility() == 0))
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (mActionBarView == null)
    {
      ...
      if (View.MeasureSpec.getMode(paramInt2) == -2147483648)
      {
        i = paramInt2;
        if (mHeight >= 0)
          i = View.MeasureSpec.makeMeasureSpec(Math.min(mHeight, View.MeasureSpec.getSize(paramInt2)), -2147483648);
      }
    }
    ...
    label172: for (paramInt2 = View.MeasureSpec.getSize(i); ; paramInt2 = 2147483647)
    {
