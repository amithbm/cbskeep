  ...
  implements NestedScrollingParent, DecorContentParent
{
  ...
  {
    boolean bool = false;
    mFlingEstimator.fling(0, 0, 0, (int)paramFloat2, 0, 0, -2147483648, 2147483647);
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((mWindowContentOverlay != null) && (!mIgnoreWindowContentOverlay))
      if (mActionBarTop.getVisibility() != 0)
        break label82;
    label82: for (int i = (int)(mActionBarTop.getBottom() + ViewCompat.getTranslationY(mActionBarTop) + 0.5F); ; i = 0)
    {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt1 < i)
    {
      ...
      label141: for (paramInt3 = paramInt4 - paramInt2 - m - i1 - localLayoutParams.bottomMargin; ; paramInt3 = k + localLayoutParams.topMargin)
      {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i3 = Math.max(0, mActionBarTop.getMeasuredWidth() + ((LayoutParams)localObject).leftMargin + ((LayoutParams)localObject).rightMargin);
    int i1 = Math.max(0, mActionBarTop.getMeasuredHeight() + ((LayoutParams)localObject).topMargin + ((LayoutParams)localObject).bottomMargin);
    ...
    if (mActionBarBottom != null)
    {
      ...
      n = Math.max(i3, mActionBarBottom.getMeasuredWidth() + ((LayoutParams)localObject).leftMargin + ((LayoutParams)localObject).rightMargin);
      m = Math.max(i1, mActionBarBottom.getMeasuredHeight() + ((LayoutParams)localObject).topMargin + ((LayoutParams)localObject).bottomMargin);
    ...
    if ((ViewCompat.getWindowSystemUiVisibility(this) & 0x100) != 0)
    {
      ...
      label299: mContentInsets.set(mBaseContentInsets);
    ...
    for (((Rect)localObject).bottom += j; ; ((Rect)localObject).bottom += j)
    {
      ...
      i = Math.max(n, mContent.getMeasuredWidth() + ((LayoutParams)localObject).leftMargin + ((LayoutParams)localObject).rightMargin);
      j = Math.max(m, mContent.getMeasuredHeight() + ((LayoutParams)localObject).topMargin + ((LayoutParams)localObject).bottomMargin);
      ...
      i1 = 0;
      break;
      label587: if (mActionBarTop.getVisibility() == 8)
        break label261;
      i = mActionBarTop.getMeasuredHeight();
      break label261;
      label610: j = mActionBarBottom.getMeasuredHeight();
      break label299;
      label622: localObject = mInnerInsets;
      ((Rect)localObject).top += i;
  ...
  public void onWindowSystemUiVisibilityChanged(int paramInt)
  {
    ...
    if ((paramInt & 0x4) == 0)
    {
      ...
      if ((paramInt & 0x100) == 0)
        break label120;
      j = 1;
      label49: if (mActionBarVisibilityCallback != null)
      {
        ActionBarVisibilityCallback localActionBarVisibilityCallback = mActionBarVisibilityCallback;
        if (j != 0)
          break label125;
        label66: localActionBarVisibilityCallback.enableContentAnimations(bool);
        if ((i == 0) && (j != 0))
          break label131;
    ...
    while (true)
    {
      ...
      label125: bool = false;
      break label66;
      label131: mActionBarVisibilityCallback.hideForSystem();
    }
  }
