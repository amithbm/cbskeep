  ...
  implements DialogInterface.OnClickListener
{
  ...
  private void setUpChild(View paramView, boolean paramBoolean)
  {
    ...
    int i = ViewGroup.getChildMeasureSpec(mHeightMeasureSpec, mSpinnerPadding.top + mSpinnerPadding.bottom, localLayoutParams1.height);
    paramView.measure(ViewGroup.getChildMeasureSpec(mWidthMeasureSpec, mSpinnerPadding.left + mSpinnerPadding.right, localLayoutParams1.width), i);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((mPopup != null) && (View.MeasureSpec.getMode(paramInt1) == -2147483648))
    ...
    implements ListAdapter, SpinnerAdapter
  {
    ...
    public DropDownAdapter(SpinnerAdapter paramSpinnerAdapter)
    {
      ...
      if ((paramSpinnerAdapter instanceof SpinnerAdapter))
        mListAdapter = ((SpinnerAdapter)paramSpinnerAdapter);
    }
