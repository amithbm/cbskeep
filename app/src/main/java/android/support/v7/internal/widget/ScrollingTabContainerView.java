  ...
  implements AdapterViewCompat.OnItemClickListener
{
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 1073741824)
    {
      ...
      label63: mMaxTabWidth = Math.min(mMaxTabWidth, mStackedTabMaxWidth);
      label78: i = View.MeasureSpec.makeMeasureSpec(mContentHeight, 1073741824);
      if ((bool) || (!mAllowCollapse))
        break label195;
      paramInt2 = 1;
      label102: if (paramInt2 == 0)
        break label208;
    ...
    while (true)
    {
      ...
      bool = false;
      break;
      label174: mMaxTabWidth = (View.MeasureSpec.getSize(paramInt1) / 2);
      break label63;
      label187: mMaxTabWidth = -1;
      break label78;
      label195: paramInt2 = 0;
      break label102;
      label200: performExpand();
      continue;
      label208: performExpand();
    }
  }
    ...
    implements View.OnLongClickListener
  {
    ...
    public TabView(Context paramTab, ActionBar.Tab paramBoolean, boolean arg4)
    {
      ...
      mTab = paramBoolean;
      this$1 = TintTypedArray.obtainStyledAttributes(paramTab, null, BG_ATTRS, R.attr.actionBarTabStyle, 0);
      if (hasValue(0))
