  ...
  implements ActionBarOverlayLayout.ActionBarVisibilityCallback
{
  ...
  private void init(View paramView)
  {
    ...
    label299: label304: for (boolean bool = true; ; bool = false)
    {
  ...
  private void setHasEmbeddedTabs(boolean paramBoolean)
  {
    ...
    if (!mHasEmbeddedTabs)
    {
      ...
      if ((mHasEmbeddedTabs) || (i == 0))
        break label172;
      paramBoolean = true;
      label97: ((DecorToolbar)localObject).setCollapsible(paramBoolean);
  ...
  public void animateToMode(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!paramBoolean)
        break label57;
      i = 8;
      label23: ((DecorToolbar)localObject).animateToVisibility(i);
      localObject = mContextView;
      if (!paramBoolean)
        break label62;
    }
    label57: label62: for (int i = j; ; i = 8)
    {
  ...
  public Context getThemedContext()
  {
    ...
    label61: for (mThemedContext = new ContextThemeWrapper(mContext, i); ; mThemedContext = mContext)
    ...
    implements MenuBuilder.Callback
  {
    ...
    {
      mActionModeContext = paramCallback;
      Object localObject;
      mCallback = localObject;
      mMenu = new MenuBuilder(paramCallback).setDefaultShowAsAction(1);
