...
public class ContentFrameLayout extends FrameLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      j = 0;
      break;
      label424: localTypedValue = mFixedWidthMajor;
      break label68;
      label433: if (localTypedValue.type != 6)
        break label115;
      i = (int)localTypedValue.getFraction(localDisplayMetrics.widthPixels, localDisplayMetrics.widthPixels);
      break label115;
      label465: localTypedValue = mFixedHeightMinor;
      break label180;
      label474: if (localTypedValue.type != 6)
        break label217;
      paramInt1 = (int)localTypedValue.getFraction(localDisplayMetrics.heightPixels, localDisplayMetrics.heightPixels);
      break label217;
      label506: localTypedValue = mMinWidthMajor;
      break label313;
      label515: if (localTypedValue.type == 6)
