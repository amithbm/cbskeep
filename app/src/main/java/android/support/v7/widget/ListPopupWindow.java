...
public class ListPopupWindow
{
  ...
  private int buildDropDown()
  {
    ...
    if (mDropDownList == null)
    {
      ...
      if (!mModal)
      {
        ...
        default:
          ...
          localView.measure(View.MeasureSpec.makeMeasureSpec(mDropDownWidth, -2147483648), 0);
          ...
          if (localObject1 != null)
          {
            ...
            label379: if (mPopup.getInputMethodMode() != 2)
              break label537;
          }
          break;
        case 1:
    ...
    label540: switch (mDropDownWidth)
    {
    default:
    ...
    while (true)
    {
      ...
      if (m > 0)
        j = i + k;
      return m + j;
      j = View.MeasureSpec.makeMeasureSpec(mContext.getResources().getDisplayMetrics().widthPixels - (mTempRect.left + mTempRect.right), -2147483648);
      continue;
  ...
  public void show()
  {
    ...
    label57: PopupWindow localPopupWindow;
    if (mPopup.isShowing())
    {
      if (mDropDownWidth == -1)
      {
        ...
        if (mDropDownWidth != -1)
          break label176;
        label76: localPopupWindow.setWindowLayoutMode(k, 0);
      }
      while (true)
      {
        localPopupWindow = mPopup;
        ...
        label176: k = 0;
        break label76;
        label181: localPopupWindow = mPopup;
        if (mDropDownWidth == -1);
        for (k = -1; ; k = 0)
        {
    ...
    {
      i = -1;
      label242: if (mDropDownHeight != -1)
        break label416;
      j = -1;
      label252: mPopup.setWindowLayoutMode(i, j);
