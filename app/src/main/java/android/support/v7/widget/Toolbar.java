...
public class Toolbar extends ViewGroup
{
  ...
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = paramContext.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, -2147483648);
  ...
  private void ensureCollapseButtonView()
  {
    if (mCollapseButtonView == null)
    {
      ...
      localLayoutParams.gravity = (0x800003 | mButtonGravity & 0x70);
  ...
  private void ensureMenuView()
  {
    if (mMenuView == null)
    {
      ...
      LayoutParams localLayoutParams = generateDefaultLayoutParams();
      localLayoutParams.gravity = (0x800005 | mButtonGravity & 0x70);
  ...
  private void measureChildConstrained(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    label132: for (paramInt1 = Math.min(View.MeasureSpec.getSize(paramInt2), paramInt5); ; paramInt1 = paramInt5)
    {
  ...
  private void setChildVisibilityForExpandedActionView(boolean paramBoolean)
  {
    ...
    if (i < k)
    {
      ...
      if ((((LayoutParams)localView.getLayoutParams()).mViewType != 2) && (localView != mMenuView))
        if (!paramBoolean)
          break label65;
      label65: for (int j = 8; ; j = 0)
      {
  ...
  {
    if ((((LayoutParams)paramView.getLayoutParams()).mViewType != 2) && (paramView != mMenuView))
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    int[] arrayOfInt;
    int i1;
    label120: boolean bool;
    label160: label200: label340: Object localObject1;
    label300: int k;
    label467: Object localObject2;
    if (ViewCompat.getLayoutDirection(this) == 1)
    {
      j = 1;
      i2 = getWidth();
      ...
      if (paramBoolean)
      {
        ...
        paramInt1 = 0 + (((LayoutParams)localObject1).topMargin + mTitleTextView.getMeasuredHeight() + ((LayoutParams)localObject1).bottomMargin);
      }
      k = paramInt1;
      if (bool)
      {
        localObject1 = (LayoutParams)mSubtitleTextView.getLayoutParams();
        k = paramInt1 + (((LayoutParams)localObject1).topMargin + mSubtitleTextView.getMeasuredHeight() + ((LayoutParams)localObject1).bottomMargin);
      }
      if (!paramBoolean)
      {
        paramInt2 = paramInt3;
      ...
      else
      {
        ...
        label478: localObject1 = (LayoutParams)((View)localObject1).getLayoutParams();
        ...
        if (((!paramBoolean) || (mTitleTextView.getMeasuredWidth() <= 0)) && ((!bool) || (mSubtitleTextView.getMeasuredWidth() <= 0)))
          break label1024;
        i = 1;
        label530: switch (mGravity & 0x70)
        {
        default:
          paramInt2 = (i4 - m - i5 - k) / 2;
          if (paramInt2 < ((LayoutParams)localObject1).topMargin + mTitleMarginTop)
          {
            paramInt1 = ((LayoutParams)localObject1).topMargin + mTitleMarginTop;
            label603: paramInt1 = m + paramInt1;
            label608: if (j == 0)
              break label1132;
            if (i == 0)
              break label1127;
    ...
    label901: label922: label943: label964: label985: label1127: for (paramInt2 = mTitleMarginStart; ; paramInt2 = 0)
    {
      ...
      paramInt4 = paramInt2;
      break label340;
      label1006: localObject1 = mSubtitleTextView;
      break label467;
      label1015: localObject2 = mTitleTextView;
      break label478;
      i = 0;
      break label530;
      paramInt1 = getPaddingTop() + ((LayoutParams)localObject1).topMargin + mTitleMarginTop;
      break label608;
      k = i4 - i5 - k - paramInt2 - m;
      paramInt1 = paramInt2;
      if (k >= ((LayoutParams)localObject1).bottomMargin + mTitleMarginBottom)
        break label603;
      paramInt1 = Math.max(0, paramInt2 - (((LayoutParams)localObject2).bottomMargin + mTitleMarginBottom - k));
      break label603;
      paramInt1 = i4 - i5 - ((LayoutParams)localObject2).bottomMargin - mTitleMarginBottom - k;
      break label608;
    }
    label1024: label1132: if (i != 0);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      i1 = 1;
      break;
      label613: k = n + measureChildCollapseMargins(localView, paramInt1, n, paramInt2, 0, arrayOfInt);
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    {
      if ((localSavedState.expandedMenuItemId != 0) && (mExpandedMenuPresenter != null) && (paramParcelable != null))
      {
  ...
  protected Parcelable onSaveInstanceState()
  {
    ...
    if ((mExpandedMenuPresenter != null) && (mExpandedMenuPresenter.mCurrentExpandedItem != null))
      localSavedState.expandedMenuItemId = mExpandedMenuPresenter.mCurrentExpandedItem.getItemId();
    ...
    implements MenuPresenter
  {
    ...
    public boolean expandItemActionView(MenuBuilder paramMenuBuilder, MenuItemImpl paramMenuItemImpl)
    {
      ...
      if (mExpandedActionView.getParent() != Toolbar.this)
      {
        ...
        paramMenuBuilder.gravity = (0x800003 | mButtonGravity & 0x70);
  ...
  public static class LayoutParams extends ActionBar.LayoutParams
  {
    ...
    {
      super();
      mViewType = paramLayoutParams.mViewType;
    }
    ...
    {
      leftMargin = paramMarginLayoutParams.leftMargin;
      topMargin = paramMarginLayoutParams.topMargin;
      rightMargin = paramMarginLayoutParams.rightMargin;
      bottomMargin = paramMarginLayoutParams.bottomMargin;
    }
  }
