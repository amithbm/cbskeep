  ...
  implements ActionProvider.SubUiVisibilityListener
{
    ...
    if (i4 < i5)
    {
      ...
      if (localMenuItemImpl.requiresActionButton())
      {
        ...
        if (mStrictWidthLimit)
        {
          ...
          label310: i1 = ((View)localObject2).getMeasuredWidth();
          m = n - i1;
          n = i;
          if (i == 0)
            n = i1;
        ...
        if (localMenuItemImpl.requestsActionButton())
        {
          ...
          if (((k > 0) || (bool)) && (n > 0) && ((!mStrictWidthLimit) || (j > 0)))
          {
            ...
            if (i8 != 0)
            {
              ...
              label524: i2 = ((View)localObject2).getMeasuredWidth();
              m = n - i2;
              i1 = i;
              if (i == 0)
                i1 = i2;
          ...
          while (!bool);
          label642: label669: ((SparseBooleanArray)localObject1).put(i7, false);
          j = 0;
          while (true)
          {
            i = k;
  ...
  public void initForMenu(Context paramContext, MenuBuilder paramMenuBuilder)
  {
    ...
    while (true)
    {
      ...
      mMinCellSize = ((int)(56.0F * paramMenuBuilder.getDisplayMetrics().density));
  ...
  public void onRestoreInstanceState(Parcelable paramParcelable)
  {
    ...
    {
      paramParcelable = mMenu.findItem(paramParcelable.openSubMenuId);
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    localSavedState.openSubMenuId = mOpenSubMenuId;
  ...
  public void updateMenuView(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      for (i = 1; ; i = 0)
        break;
      label288: if ((mOverflowButton != null) && (mOverflowButton.getParent() == mMenuView))
  ...
  private class ActionButtonSubmenu extends MenuPopupHelper
  {
    ...
    public ActionButtonSubmenu(Context paramSubMenuBuilder, SubMenuBuilder arg3)
    {
      ...
      if (!((MenuItemImpl)localMenuBuilder.getItem()).isActionButton())
      {
        if (mOverflowButton == null)
        {
          paramSubMenuBuilder = (View)mMenuView;
          setAnchorView(paramSubMenuBuilder);
        }
      }
      else
      {
      ...
      while (true)
      {
        ...
        if (i < j)
        {
          this$1 = localMenuBuilder.getItem(i);
