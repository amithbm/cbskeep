  ...
  implements NestedScrollingChild, ScrollingView
{
  ...
  private void animateAppearance(ViewHolder paramViewHolder, Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    if ((paramRect != null) && ((paramRect.left != paramInt1) || (paramRect.top != paramInt2)))
    {
      ...
      if (mItemAnimator.animateMove(paramViewHolder, paramRect.left, paramRect.top, paramInt1, paramInt2))
        postAnimationRunner();
    }
    do
    {
  ...
  private void animateDisappearance(ItemHolderInfo paramItemHolderInfo)
  {
    ...
    if ((!paramItemHolderInfo.holder.isRemoved()) && ((i != k) || (j != m)))
    {
      ...
      if (mItemAnimator.animateMove(paramItemHolderInfo.holder, i, j, k, m))
        postAnimationRunner();
    }
    do
    {
    ...
    while (!mItemAnimator.animateRemove(paramItemHolderInfo.holder));
    postAnimationRunner();
  }
  ...
  private int getAdapterPositionFor(ViewHolder paramViewHolder)
  {
    if ((paramViewHolder.hasAnyOfTheFlags(524)) || (!paramViewHolder.isBound()))
      return -1;
    return mAdapterHelper.applyPendingUpdatesToPosition(paramViewHolder.mPosition);
  }
  ...
  private void processAdapterUpdatesAndSetAnimationFlags()
  {
    ...
    if ((mItemAnimator != null) && (mLayout.supportsPredictiveItemAnimations()))
    {
      ...
      if ((!mFirstLayoutComplete) || (mItemAnimator == null) || ((!mDataSetHasChangedAfterLayout) && (i == 0) && (!mLayout.mRequestedSimpleAnimations)) || ((mDataSetHasChangedAfterLayout) && (!mAdapter.hasStableIds())))
        break label215;
      bool1 = true;
      label149: State.access$1602(localState, bool1);
      localState = mState;
      if ((!mState.mRunSimpleAnimations) || (i == 0) || (mDataSetHasChangedAfterLayout) || (!predictiveItemAnimationsEnabled()))
        break label220;
    }
    label210: label215: label220: for (boolean bool1 = bool2; ; bool1 = false)
    {
  ...
  void dispatchLayout()
  {
    ...
    do
    {
        ...
        while (i < mChildHelper.getChildCount())
        {
          ...
          else
          {
            ...
            while (true)
            {
              ...
              {
                if (((ViewHolder)mState.mPreLayoutHolderMap.keyAt(j)).itemView == localObject1)
                  k = 1;
              }
              else
              {
      ...
      while (i >= 0)
      {
        ...
        if (!mState.mPostLayoutHolderMap.containsKey(localObject3))
        {
          ...
          mRecycler.unscrapView(((ItemHolderInfo)localObject3).holder);
      ...
      while (i < j)
      {
        ...
        if ((localObject4 != null) && (localObject3 != null) && ((((ItemHolderInfo)localObject4).left != ((ItemHolderInfo)localObject3).left) || (((ItemHolderInfo)localObject4).top != ((ItemHolderInfo)localObject3).top)))
        {
          ...
          if (mItemAnimator.animateMove((ViewHolder)localObject2, ((ItemHolderInfo)localObject4).left, ((ItemHolderInfo)localObject4).top, ((ItemHolderInfo)localObject3).left, ((ItemHolderInfo)localObject3).top))
            postAnimationRunner();
        }
        i += 1;
      }
    ...
    label305: label713: label750: label760: dispatchOnScrolled(0, 0);
    label920: label926: label932: label1471: return;
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (mBottomGlow != null)
    {
      ...
      if (!mBottomGlow.isFinished())
      {
        ...
        label375: if ((mBottomGlow == null) || (!mBottomGlow.draw(paramCanvas)))
          break label500;
      }
    }
  ...
  Rect getItemDecorInsetsForChild(View paramView)
  {
    ...
    while (i < j)
    {
      ...
      localRect.left += mTempRect.left;
      localRect.top += mTempRect.top;
      localRect.right += mTempRect.right;
      localRect.bottom += mTempRect.bottom;
      i += 1;
    }
    ...
    mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback()
    {
      void dispatchUpdate(AdapterHelper.UpdateOp paramAnonymousUpdateOp)
      {
        ...
        default:
          return;
        case 0:
          mLayout.onItemsAdded(RecyclerView.this, paramAnonymousUpdateOp.positionStart, paramAnonymousUpdateOp.itemCount);
          return;
        case 1:
          mLayout.onItemsRemoved(RecyclerView.this, paramAnonymousUpdateOp.positionStart, paramAnonymousUpdateOp.itemCount);
          return;
        case 2:
          mLayout.onItemsUpdated(RecyclerView.this, paramAnonymousUpdateOp.positionStart, paramAnonymousUpdateOp.itemCount);
          return;
        case 3:
        }
        mLayout.onItemsMoved(RecyclerView.this, paramAnonymousUpdateOp.positionStart, paramAnonymousUpdateOp.itemCount, 1);
      }
      ...
      public RecyclerView.ViewHolder findViewHolder(int paramAnonymousInt)
      {
        ...
        while (!mChildHelper.isHidden(localViewHolder2.itemView));
        return null;
      }
  ...
  void offsetPositionRecordsForMove(int paramInt1, int paramInt2)
  {
    ...
    label131: mRecycler.offsetPositionRecordsForMove(paramInt1, paramInt2);
    requestLayout();
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      State.access$1502(mState, false);
      break;
      label107: mState.mItemCount = 0;
      break label65;
      label118: mLayout.onMeasure(mRecycler, mState, paramInt1, paramInt2);
    }
  }
  ...
  protected Parcelable onSaveInstanceState()
  {
    ...
    if (mLayout != null)
    {
      localSavedState.mLayoutState = mLayout.onSaveInstanceState();
      return localSavedState;
    }
    ...
    while (true)
    {
      ...
      if (mScrollState == 1)
      {
        ...
        while (scrollByInternal(n, m, localMotionEvent))
        {
          getParent().requestDisallowInterceptTouchEvent(true);
          break;
          label747: k = j + mTouchSlop;
          break label598;
          label759: j = i + mTouchSlop;
          break label648;
          n = 0;
          break label716;
          label777: m = 0;
        ...
        label889: for (float f2 = -VelocityTrackerCompat.getYVelocity(mVelocityTracker, mScrollPointerId); ; f2 = 0.0F)
        {
  ...
  void rebindUpdatedViewHolders()
  {
    ...
    if (i < j)
    {
      ...
      while (true)
      {
        ...
        {
          int k = mAdapter.getItemViewType(localViewHolder.mPosition);
          if (localViewHolder.getItemViewType() != k)
            break label140;
          if ((!localViewHolder.isChanged()) || (!supportsChangeAnimations()))
            mAdapter.bindViewHolder(localViewHolder, localViewHolder.mPosition);
          else
            requestLayout();
        }
      }
      label140: requestLayout();
    }
  }
    ...
    if (mAdapter != null)
    {
      ...
      if (supportsChangeAnimations())
      {
        ...
        if (n < i1)
        {
          ...
          label274: for (localObject = ((ViewHolder)localObject).itemView; ; localObject = null)
          {
            if (localObject != null)
            {
    ...
    implements RecyclerView.ItemAnimator.ItemAnimatorListener
  {
    ...
    public void onRemoveFinished(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      if ((!RecyclerView.this.removeAnimatingView(paramViewHolder.itemView)) && (paramViewHolder.isTmpDetached()))
        removeDetachedView(paramViewHolder.itemView, false);
    }
  }
  ...
  public static abstract class LayoutManager
  {
    ...
    private void addViewInt(View paramView, int paramInt, boolean paramBoolean)
    {
      ...
      if ((paramBoolean) || (localViewHolder.isRemoved()))
      {
        ...
        label67: mChildHelper.attachViewToParent(paramView, paramInt, paramView.getLayoutParams(), false);
      }
      while (true)
      {
        ...
        break label67;
        label126: if (paramView.getParent() == mRecyclerView)
        {
    ...
    {
      RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramView);
      if ((localViewHolder != null) && (!localViewHolder.isRemoved()) && (!mChildHelper.isHidden(localViewHolder.itemView)))
    ...
    void setRecyclerView(RecyclerView paramRecyclerView)
    {
      ...
      mChildHelper = paramRecyclerView.mChildHelper;
    }
  ...
  public final class Recycler
  {
    ...
    {
      return ((RecyclerView.ViewHolder)mAttachedScrap.get(paramInt)).itemView;
    }
      ...
      while (i >= 0)
      {
        ...
        if ((localViewHolder2.getItemId() == paramLong) && (!localViewHolder2.wasReturnedFromScrap()))
        {
          ...
          if (!paramBoolean)
          {
            ...
            removeDetachedView(localViewHolder2.itemView, false);
    ...
    View getViewForPosition(int paramInt, boolean paramBoolean)
    {
          ...
          if (localObject2 != null)
          {
            ...
            if (!paramBoolean)
            {
              ...
              if (!((RecyclerView.ViewHolder)localObject2).isScrap())
                break label317;
              removeDetachedView(((RecyclerView.ViewHolder)localObject2).itemView, false);
      ...
      while (true)
      {
        ...
        j = 0;
        break;
        label317: if (!((RecyclerView.ViewHolder)localObject2).wasReturnedFromScrap())
          break label190;
      ...
      label342: int m = mAdapter.getItemViewType(k);
      j = i;
      localObject2 = localObject1;
      if (mAdapter.hasStableIds())
      {
      ...
      if ((mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject2).isBound()))
      {
        ...
        label670: ((RecyclerView.LayoutParams)localObject1).mViewHolder = ((RecyclerView.ViewHolder)localObject2);
        if ((k == 0) || (i == 0))
          break label848;
      }
      label799: label848: for (paramBoolean = bool; ; paramBoolean = false)
      {
    ...
    void markItemDecorInsetsDirty()
    {
      ...
      while (i < j)
      {
        RecyclerView.LayoutParams localLayoutParams = (RecyclerView.LayoutParams)((RecyclerView.ViewHolder)mCachedViews.get(i)).itemView.getLayoutParams();
    ...
    void offsetPositionRecordsForMove(int paramInt1, int paramInt2)
    {
      ...
      while (true)
      {
        ...
        j = 1;
        break;
        label90: if (localViewHolder.mPosition == paramInt1)
          localViewHolder.offsetPosition(paramInt2 - paramInt1, false);
        else
          localViewHolder.offsetPosition(j, false);
      }
    ...
    boolean validateViewHolderForOffsetPosition(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      {
        return true;
        if ((paramViewHolder.mPosition < 0) || (paramViewHolder.mPosition >= mAdapter.getItemCount()))
          throw new IndexOutOfBoundsException("Inconsistency detected. Invalid view holder adapter position" + paramViewHolder);
        if ((!mState.isPreLayout()) && (mAdapter.getItemViewType(paramViewHolder.mPosition) != paramViewHolder.getItemViewType()))
          return false;
      }
      while ((!mAdapter.hasStableIds()) || (paramViewHolder.getItemId() == mAdapter.getItemId(paramViewHolder.mPosition)));
      return false;
    }
  ...
  static class SavedState extends View.BaseSavedState
  {
    ...
    {
      mLayoutState = paramSavedState.mLayoutState;
    }
    ...
    private void onAnimation(int paramInt1, int paramInt2)
    {
      ...
      if (mTargetView != null)
      {
        if (getChildPosition(mTargetView) != mTargetPosition)
          break label151;
        onTargetFound(mTargetView, localRecyclerView.mState, mRecyclingAction);
      ...
      while (true)
      {
        if (mRunning)
        {
          onSeekTargetStep(paramInt1, paramInt2, localRecyclerView.mState, mRecyclingAction);
      ...
      private void runIfNecessary(RecyclerView paramRecyclerView)
      {
        ...
        if (changed)
        {
          ...
          if (mInterpolator == null)
            if (mDuration == -2147483648)
              paramRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy);
          while (true)
          {
            ...
            changed = false;
            return;
            paramRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration);
            continue;
            paramRecyclerView.mViewFlinger.smoothScrollBy(mDx, mDy, mDuration, mInterpolator);
          }
        }
  ...
  public static class State
  {
    ...
    void onViewRecycled(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      mDisappearingViewsInLayoutPass.remove(paramViewHolder.itemView);
    }
    ...
    implements Runnable
  {
    ...
    private int computeScrollDuration(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
      ...
      label140: for (paramInt1 = getWidth(); ; paramInt1 = getHeight())
      {
    ...
    public void fling(int paramInt1, int paramInt2)
    {
      ...
      mLastFlingY = 0;
      mLastFlingX = 0;
      mScroller.fling(0, 0, paramInt1, paramInt2, -2147483648, 2147483647, -2147483648, 2147483647);
      postOnAnimation();
    }
    ...
    public void run()
    {
      ...
      if (localScrollerCompat.computeScrollOffset())
      {
        ...
        if ((i1 != 0) || (i2 != 0))
        {
          ...
          label561: if (ViewCompat.getOverScrollMode(RecyclerView.this) != 2)
            absorbGlows(i, j);
        ...
        if ((i5 == 0) || (!mLayout.canScrollVertically()) || (i3 != i5))
          break label900;
        i = 1;
        label689: if ((i4 == 0) || (!mLayout.canScrollHorizontally()) || (n != i4))
          break label905;
        j = 1;
        label716: if (((i4 != 0) || (i5 != 0)) && (j == 0) && (i == 0))
          break label910;
        i = 1;
        label736: if ((!localScrollerCompat.isFinished()) && (i != 0))
          break label915;
      ...
      while (true)
      {
        ...
        return;
        label793: if (localSmoothScroller.getTargetPosition() >= n)
        {
