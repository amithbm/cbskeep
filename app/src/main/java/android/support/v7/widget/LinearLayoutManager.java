  ...
  implements ItemTouchHelper.ViewDropHandler
{
  ...
  private void layoutForPredictiveAnimations(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2)
  {
    ...
    if (i < n)
    {
      ...
      while (true)
      {
        ...
        {
          i2 = 1;
          label115: if (i2 == mShouldReverseLayout)
            break label159;
        }
        label159: for (int m = -1; ; m = 1)
        {
          if (m != -1)
            break label165;
          j += mOrientationHelper.getDecoratedMeasurement(localViewHolder.itemView);
          break;
          i2 = 0;
          break label115;
        }
        label165: k += mOrientationHelper.getDecoratedMeasurement(localViewHolder.itemView);
      }
    }
  ...
  private boolean updateAnchorFromChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, AnchorInfo paramAnchorInfo)
  {
    ...
    label162: label164: label170: for (int i = mOrientationHelper.getEndAfterPadding(); ; i = mOrientationHelper.getStartAfterPadding())
    {
  ...
  private boolean updateAnchorFromPendingData(RecyclerView.State paramState, AnchorInfo paramAnchorInfo)
  {
    ...
    {
      paramAnchorInfo.mLayoutFromEnd = mPendingSavedState.mAnchorLayoutFromEnd;
      if (paramAnchorInfo.mLayoutFromEnd)
      {
        paramAnchorInfo.mCoordinate = (mOrientationHelper.getEndAfterPadding() - mPendingSavedState.mAnchorOffset);
        return true;
      }
      paramAnchorInfo.mCoordinate = (mOrientationHelper.getStartAfterPadding() + mPendingSavedState.mAnchorOffset);
      return true;
    }
    if (mPendingScrollPositionOffset == -2147483648)
    {
      ...
      if (paramState != null)
      {
        ...
        {
          paramAnchorInfo.mCoordinate = mOrientationHelper.getStartAfterPadding();
        ...
        {
          paramAnchorInfo.mCoordinate = mOrientationHelper.getEndAfterPadding();
    ...
    paramAnchorInfo.mLayoutFromEnd = mShouldReverseLayout;
    if (mShouldReverseLayout)
    {
      paramAnchorInfo.mCoordinate = (mOrientationHelper.getEndAfterPadding() - mPendingScrollPositionOffset);
      return true;
    }
    paramAnchorInfo.mCoordinate = (mOrientationHelper.getStartAfterPadding() + mPendingScrollPositionOffset);
    return true;
  }
  ...
  private void updateLayoutState(int paramInt1, int paramInt2, boolean paramBoolean, RecyclerView.State paramState)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramState.mExtra += mOrientationHelper.getEndPadding();
    ...
    localLayoutState.mExtra += mOrientationHelper.getStartAfterPadding();
    localLayoutState = mLayoutState;
    if (mShouldReverseLayout);
  ...
  private void updateLayoutStateToFillEnd(int paramInt1, int paramInt2)
  {
    ...
    for (int i = -1; ; i = 1)
    {
      ...
      mLayoutState.mScrollingOffset = -2147483648;
      return;
    }
  }
  ...
  int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      int j;
      if ((localLayoutChunkResult.mIgnoreConsumed) && (mLayoutState.mScrapList == null))
      {
        j = i;
  ...
  View findReferenceChild(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      i = -1;
      break;
      label131: if (mOrientationHelper.getDecoratedStart(localView) < k)
      {
        localObject1 = localView;
    ...
    label183: if (paramRecycler != null);
    while (true)
    {
      localObject1 = paramRecycler;
      label190: return localObject1;
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LayoutState paramLayoutState, LayoutChunkResult paramLayoutChunkResult)
  {
    ...
    if (paramLayoutState.mScrapList == null)
    {
      ...
      if (paramLayoutState.mLayoutDirection == -1)
      {
        ...
        paramLayoutChunkResult.mConsumed = mOrientationHelper.getDecoratedMeasurement(paramRecycler);
        if (mOrientation != 1)
          break label314;
        if (!isLayoutRTL())
          break label271;
    ...
    while (true)
    {
      ...
      bool1 = false;
      break;
      label215: addView(paramRecycler, 0);
      break label61;
      bool2 = mShouldReverseLayout;
      if (paramLayoutState.mLayoutDirection == -1);
      ...
      label262: addDisappearingView(paramRecycler, 0);
      break label61;
      label271: j = getPaddingLeft();
      k = j + mOrientationHelper.getDecoratedMeasurementInOther(paramRecycler);
      break label120;
      label293: m = paramLayoutState.mOffset;
      i = paramLayoutState.mOffset + paramLayoutChunkResult.mConsumed;
      continue;
      label314: m = getPaddingTop();
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    if (mLayoutState.mLastScrollDelta >= 0)
    {
      ...
      ((LayoutState)localObject).mCurrentPosition += mLayoutState.mItemDirection;
      fill(paramRecycler, mLayoutState, paramState, false);
    ...
    for (int k = i + k + j; ; k = i + n)
    {
      ...
      i = 0;
      break;
      label590: i = mOrientationHelper.getDecoratedStart((View)localObject);
      ...
      j = k;
      break label229;
      label634: updateLayoutStateToFillEnd(mAnchorInfo);
      mLayoutState.mExtra = i;
      fill(paramRecycler, mLayoutState, paramState, false);
      k = mLayoutState.mOffset;
      n = mLayoutState.mCurrentPosition;
      ...
      j = m;
      break label463;
      label833: k = fixLayoutStartGap(j, paramRecycler, paramState, true);
      i += k;
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    if (getChildCount() > 0)
    {
      ...
      if (bool)
      {
        ...
        localSavedState.mAnchorOffset = (mOrientationHelper.getEndAfterPadding() - mOrientationHelper.getDecoratedEnd(localView));
        localSavedState.mAnchorPosition = getPosition(localView);
        return localSavedState;
      }
      View localView = getChildClosestToStart();
      localSavedState.mAnchorPosition = getPosition(localView);
      localSavedState.mAnchorOffset = (mOrientationHelper.getDecoratedStart(localView) - mOrientationHelper.getStartAfterPadding());
      return localSavedState;
    }
    ...
    implements Parcelable
  {
    ...
    public SavedState(SavedState paramSavedState)
    {
      ...
      mAnchorOffset = paramSavedState.mAnchorOffset;
