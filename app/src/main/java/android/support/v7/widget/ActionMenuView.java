  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  static int measureChildForCells(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label182: label188: for (boolean bool = true; ; bool = false)
    {
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < i12)
    {
      ...
      else
      {
        ...
        label430: for (paramInt2 = 1; ; paramInt2 = paramInt1)
        {
    ...
    while (true)
    {
      ...
      i1 = 0;
      break;
      label551: if (((LayoutParams)localObject).cellsUsed < i3)
      {
    ...
    while (true)
    {
      ...
      paramInt2 = 1;
      break;
      label1004: paramInt1 = 0;
      break label654;
      label1009: j = 0;
      break label814;
      label1015: localObject = getChildAt(k);
      localLayoutParams = (LayoutParams)((View)localObject).getLayoutParams();
  ...
  public Menu getMenu()
  {
    ...
    label110: for (Object localObject = mActionMenuPresenterCallback; ; localObject = new ActionMenuPresenterCallback(null))
    {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      paramInt1 = 0;
      label383: paramInt1 = paramInt4 - paramInt1;
      if (paramInt1 <= 0)
        break label481;
      paramInt1 = paramInt2 / paramInt1;
      label396: paramInt4 = Math.max(0, paramInt1);
      if (!paramBoolean)
        break label552;
      paramInt2 = getWidth() - getPaddingRight();
      paramInt1 = 0;
      label419: if (paramInt1 < i2)
      {
    ...
    for (paramInt3 = paramInt2; ; paramInt3 = paramInt2 - (localLayoutParams.leftMargin + paramInt3 + paramInt4))
    {
      ...
      paramInt1 = 1;
      break label383;
      label481: paramInt1 = 0;
      break label396;
      label486: paramInt2 -= localLayoutParams.rightMargin;
      paramInt3 = localView.getMeasuredWidth();
      i = localView.getMeasuredHeight();
      j = i1 - i / 2;
      localView.layout(paramInt2 - paramInt3, j, paramInt2, j + i);
    }
    label552: paramInt2 = getPaddingLeft();
    paramInt1 = 0;
    label559: if (paramInt1 < i2)
    {
      localView = getChildAt(paramInt1);
      localLayoutParams = (LayoutParams)localView.getLayoutParams();
      paramInt3 = paramInt2;
    ...
    for (paramInt3 = paramInt2; ; paramInt3 = paramInt2 + (localLayoutParams.rightMargin + paramInt3 + paramInt4))
    {
      ...
      break label559;
      break;
      label616: paramInt2 += localLayoutParams.leftMargin;
      paramInt3 = localView.getMeasuredWidth();
      i = localView.getMeasuredHeight();
      j = i1 - i / 2;
  ...
  public static class LayoutParams extends LinearLayoutCompat.LayoutParams
  {
    ...
    {
      super();
      isOverflowButton = paramLayoutParams.isOverflowButton;
    }
