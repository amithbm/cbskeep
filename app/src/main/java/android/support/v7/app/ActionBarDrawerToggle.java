  ...
  implements DrawerLayout.DrawerListener
{
  ...
  <T extends Drawable,  extends DrawerToggle> ActionBarDrawerToggle(Activity paramActivity, Toolbar paramToolbar, DrawerLayout paramDrawerLayout, T paramT, int paramInt1, int paramInt2)
  {
    ...
    label180: for (mSlider = new DrawerArrowDrawableToggle(paramActivity, mActivityImpl.getActionBarThemedContext()); ; mSlider = ((DrawerToggle)paramT))
    {
  ...
  public void setDrawerIndicatorEnabled(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      return;
      label49: i = mOpenDrawerContentDescRes;
      break;
      label57: setActionBarUpIndicator(mHomeAsUpIndicator, 0);
    }
  }
  ...
  public void syncState()
  {
    ...
    label74: for (int i = mCloseDrawerContentDescRes; ; i = mOpenDrawerContentDescRes)
    {
      setActionBarUpIndicator(localDrawable, i);
      return;
      mSlider.setPosition(0.0F);
