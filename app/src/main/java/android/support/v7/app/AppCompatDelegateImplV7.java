  ...
  implements LayoutInflaterFactory, MenuBuilder.Callback
{
  ...
  {
    if ((paramBoolean) && (paramPanelFeatureState.featureId == 0) && (mDecorContentParent != null) && (mDecorContentParent.isOverflowMenuShowing()))
    ...
    if (!mSubDecorInstalled)
    {
      ...
      while (mSubDecor == null)
      {
        ...
        if (mHasActionBar)
        {
          ...
          for (localObject1 = new ContextThemeWrapper(mContext, ((TypedValue)localObject1).resourceId); ; localObject1 = mContext)
          {
          ...
          label303: ((FitWindowsViewGroup)mSubDecor).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener()
          {
      ...
      if ((!isDestroyed()) && ((localObject1 == null) || (((PanelFeatureState)localObject1).menu == null)))
  ...
  private boolean initializePanelContent(PanelFeatureState paramPanelFeatureState)
  {
    ...
    do
    {
      ...
      paramPanelFeatureState.shownPanelView = ((View)paramPanelFeatureState.getListMenuView(mPanelMenuPresenterCallback));
    }
  ...
  private boolean initializePanelMenu(PanelFeatureState paramPanelFeatureState)
  {
    ...
    while (true)
    {
      ...
      return true;
      label197: localTheme.resolveAttribute(R.attr.actionBarWidgetTheme, localTypedValue, true);
    }
  }
  ...
  private boolean onKeyUpPanel(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    label239: Log.w("AppCompatDelegate", "Couldn't get audio manager");
    return bool1;
  }
  ...
  private void openPanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    int i;
    int j;
    label109: label114: label118: label120: WindowManager localWindowManager;
    do
    {
      do
      {
  ...
  private boolean preparePanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    for (int i = 1; ; i = 0)
    {
      ...
      if ((i != 0) && (mDecorContentParent != null))
      {
        ...
        mDecorContentParent.setMenu(paramPanelFeatureState.menu, mActionMenuPresenterCallback);
      }
    ...
    label273: paramPanelFeatureState.refreshMenuContent = false;
    label278: paramPanelFeatureState.menu.stopDispatchingItemsChanged();
    ...
    label408: label430: for (boolean bool = true; ; bool = false)
    {
  ...
  private int updateStatusGuard(int paramInt)
  {
    ...
    label406: for (paramInt = i1; ; paramInt = 8)
    {
      ((View)localObject1).setVisibility(paramInt);
      return i;
      label322: j = 0;
      break;
      label327: localObject2 = mStatusGuard.getLayoutParams();
      i = j;
      ...
      while (true)
      {
        ...
        if (mActionModeView == null)
        {
          ...
          if (((TypedValue)localObject3).resourceId != 0)
          {
            ...
            label212: mActionModeView = new ActionBarContextView((Context)localObject1);
        ...
        {
          label322: if (mActionModeView == null)
            break label531;
        ...
        label531: label533: for (boolean bool = true; ; bool = false)
        {
          ...
          break label212;
          label486: localObject1 = (ViewStubCompat)mSubDecor.findViewById(R.id.action_mode_bar_stub);
          if (localObject1 == null)
            break label322;
