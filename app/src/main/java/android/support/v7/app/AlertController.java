...
class AlertController
{
  ...
  private boolean setupButtons()
  {
    ...
    if (TextUtils.isEmpty(mButtonPositiveText))
    {
      ...
      label95: mButtonNeutral = ((Button)mWindow.findViewById(16908315));
      mButtonNeutral.setOnClickListener(mButtonHandler);
      if (!TextUtils.isEmpty(mButtonNeutralText))
        break label223;
      mButtonNeutral.setVisibility(8);
      label142: if (shouldCenterSingleButton(mContext))
      {
        if (i != 1)
          break label249;
    ...
    while (true)
    {
      ...
      i = 0x0 | 0x1;
      break;
      label197: mButtonNegative.setText(mButtonNegativeText);
      mButtonNegative.setVisibility(0);
      i |= 2;
      break label95;
      label223: mButtonNeutral.setText(mButtonNeutralText);
  ...
  private void setupView()
  {
    ...
    if (mView != null)
    {
      ...
      if (localObject == null)
        break label322;
      i = 1;
      label133: if ((i == 0) || (!canTextInput((View)localObject)))
    ...
    while (true)
    {
      ...
      label322: i = 0;
      break label133;
      label327: localFrameLayout1.setVisibility(8);
    }
  }
  ...
  public static class AlertParams
  {
    ...
    {
      final ListView localListView = (ListView)mInflater.inflate(paramAlertController.mListLayout, null);
      Object localObject;
      if (mIsMultiChoice)
        if (mCursor == null)
        {
          localObject = new ArrayAdapter(mContext, paramAlertController.mMultiChoiceItemLayout, 16908308, mItems)
          {
          ...
          localListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
          {
            ...
            {
              mOnClickListener.onClick(paramAlertController.mDialog, paramAnonymousInt);
              if (!mIsSingleChoice)
                paramAlertController.mDialog.dismiss();
            }
          });
          label110: if (mOnItemSelectedListener != null)
      ...
      while (true)
      {
        ...
        localObject = new CursorAdapter(mContext, mCursor, false)
        {
          ...
          {
            return mInflater.inflate(paramAlertController.mMultiChoiceItemLayout, paramAnonymousViewGroup, false);
          }
        };
        break;
        int i;
        if (mIsSingleChoice)
        {
          ...
          label183: if (mCursor != null)
            break label235;
          if (mAdapter == null)
            break label213;
        }
        label213: for (localObject = mAdapter; ; localObject = new AlertController.CheckedItemAdapter(mContext, i, 16908308, mItems))
        {
          break;
          i = paramAlertController.mListItemLayout;
          break label183;
        }
        label235: localObject = new SimpleCursorAdapter(mContext, i, mCursor, new String[] { mLabelColumn }, new int[] { 16908308 });
        break;
        label274: if (mOnCheckboxClickListener == null)
          break label110;
        localListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
          public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
          {
            ...
            mOnCheckboxClickListener.onClick(paramAlertController.mDialog, paramAnonymousInt, localListView.isItemChecked(paramAnonymousInt));
          }
        });
        break label110;
        label300: if (mIsMultiChoice)
  ...
  private static final class ButtonHandler extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      case -2:
      case -1:
        ((DialogInterface.OnClickListener)paramMessage.obj).onClick((DialogInterface)mDialog.get(), paramMessage.what);
        return;
      case 1:
      }
