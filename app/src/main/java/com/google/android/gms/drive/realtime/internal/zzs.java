...
public abstract interface zzs extends IInterface
{
  ...
  public abstract void zzhL(int paramInt)
    throws RemoteException;
    ...
    implements zzs
  {
    public zza()
    {
      attachInterface(this, "com.google.android.gms.drive.realtime.internal.IIntCallback");
    }

    public static zzs zzcG(IBinder paramIBinder)
    {
