...
public abstract interface zzau extends IInterface
{
  public abstract AccountChangeEventsResponse getAccountChangeEvents(AccountChangeEventsRequest paramAccountChangeEventsRequest)
    ...
    implements zzau
  {
      ...
      throws RemoteException
    {
      ...
      case 3:
        label144: label218: paramParcel1.enforceInterface("com.google.android.auth.IAuthManagerService");
        if (paramParcel1.readInt() != 0)
        {
          paramParcel1 = (AccountChangeEventsRequest)AccountChangeEventsRequest.CREATOR.createFromParcel(paramParcel1);
          paramParcel1 = getAccountChangeEvents(paramParcel1);
          paramParcel2.writeNoException();
          if (paramParcel1 == null)
            break label284;
          paramParcel2.writeInt(1);
        ...
        while (true)
        {
          ...
          paramParcel1 = null;
          break;
          label284: paramParcel2.writeInt(0);
        }
      case 5:
      }
      paramParcel1.enforceInterface("com.google.android.auth.IAuthManagerService");
      if (paramParcel1.readInt() != 0)
      {
        ...
        if (paramParcel1.readInt() == 0)
          break label382;
        paramParcel1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);
        label345: paramParcel1 = zza((Account)localObject, str, paramParcel1);
        paramParcel2.writeNoException();
        if (paramParcel1 == null)
          break label387;
        paramParcel2.writeInt(1);
      ...
      while (true)
      {
        ...
        localObject = null;
        break;
        label382: paramParcel1 = null;
        break label345;
        label387: paramParcel2.writeInt(0);
      }
    }
      ...
      implements zzau
    {
      ...
      public AccountChangeEventsResponse getAccountChangeEvents(AccountChangeEventsRequest paramAccountChangeEventsRequest)
        throws RemoteException
      {
