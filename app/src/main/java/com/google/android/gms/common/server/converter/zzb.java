  ...
  implements Parcelable.Creator<StringToIntConverter>
{
  static void zza(StringToIntConverter paramStringToIntConverter, Parcel paramParcel, int paramInt)
  {
    ...
    com.google.android.gms.common.internal.safeparcel.zzb.zzd(paramParcel, 2, paramStringToIntConverter.zzql(), false);
    com.google.android.gms.common.internal.safeparcel.zzb.zzJ(paramParcel, paramInt);
  }

  public StringToIntConverter zzcW(Parcel paramParcel)
  {
  ...
  public StringToIntConverter[] zzfa(int paramInt)
  {
