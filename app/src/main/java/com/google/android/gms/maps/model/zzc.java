  ...
  implements Parcelable.Creator<GroundOverlayOptions>
{
  static void zza(GroundOverlayOptions paramGroundOverlayOptions, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramGroundOverlayOptions.zzzR(), false);
  ...
  public GroundOverlayOptions zziY(Parcel paramParcel)
  {
  ...
  public GroundOverlayOptions[] zzmj(int paramInt)
  {
