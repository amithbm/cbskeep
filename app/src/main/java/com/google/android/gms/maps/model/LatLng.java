  ...
  implements SafeParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    while ((Double.doubleToLongBits(latitude) == Double.doubleToLongBits(paramObject.latitude)) && (Double.doubleToLongBits(longitude) == Double.doubleToLongBits(paramObject.longitude)));
    return false;
  }
