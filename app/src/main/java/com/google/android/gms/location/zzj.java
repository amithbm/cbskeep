  ...
  implements Parcelable.Creator<LocationSettingsStates>
{
  static void zza(LocationSettingsStates paramLocationSettingsStates, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 7, paramLocationSettingsStates.zzyo());
    zzb.zzJ(paramParcel, paramInt);
  }

  public LocationSettingsStates zzhQ(Parcel paramParcel)
  {
    boolean bool1 = false;
  ...
  public LocationSettingsStates[] zzkP(int paramInt)
  {
