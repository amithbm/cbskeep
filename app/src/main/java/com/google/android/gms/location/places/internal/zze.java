...
public abstract interface zze extends IInterface
{
  ...
  public static abstract class zza extends Binder
    implements zze
  {
    public static zze zzed(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 2:
        ...
        {
          zza((PlaceRequest)localObject1, (PlacesParams)localObject2, localPendingIntent, zzh.zza.zzeg(paramParcel1.readStrongBinder()));
      ...
      case 3:
        ...
        {
          zza((PlacesParams)localObject1, (PendingIntent)localObject2, zzh.zza.zzeg(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
          localObject1 = null;
          break;
      ...
      case 4:
        ...
        if (paramParcel1.readInt() != 0)
        {
          localObject1 = NearbyAlertRequest.CREATOR.zzit(paramParcel1);
          if (paramParcel1.readInt() == 0)
            break label359;
          localObject2 = PlacesParams.CREATOR.zziF(paramParcel1);
          if (paramParcel1.readInt() == 0)
        ...
        for (localPendingIntent = (PendingIntent)PendingIntent.CREATOR.createFromParcel(paramParcel1); ; localPendingIntent = null)
        {
          zza((NearbyAlertRequest)localObject1, (PlacesParams)localObject2, localPendingIntent, zzh.zza.zzeg(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
          localObject1 = null;
          break;
      ...
      case 5:
        ...
        for (localObject2 = (PendingIntent)PendingIntent.CREATOR.createFromParcel(paramParcel1); ; localObject2 = null)
        {
          zzb((PlacesParams)localObject1, (PendingIntent)localObject2, zzh.zza.zzeg(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
          localObject1 = null;
          break;
      ...
      case 6:
        label133: label183: label189: label359: label365: paramParcel1.enforceInterface("com.google.android.gms.location.places.internal.IGooglePlaceDetectionService");
        label265: label309: label441: if (paramParcel1.readInt() != 0);
        for (localObject1 = PlaceFilter.CREATOR.zziu(paramParcel1); ; localObject1 = null)
        {
          if (paramParcel1.readInt() != 0)
            localObject2 = PlacesParams.CREATOR.zziF(paramParcel1);
          zza((PlaceFilter)localObject1, (PlacesParams)localObject2, zzh.zza.zzeg(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        }
      case 7:
      ...
      for (Object localObject1 = (PlaceReport)PlaceReport.CREATOR.createFromParcel(paramParcel1); ; localObject1 = null)
      {
        ...
        if (paramParcel1.readInt() != 0)
          localObject2 = PlacesParams.CREATOR.zziF(paramParcel1);
        zza((PlaceReport)localObject1, (PlacesParams)localObject2, zzh.zza.zzeg(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
    }
      ...
      implements zze
    {
        ...
        throws RemoteException
      {
        ...
        while (true)
        {
          ...
          continue;
          label159: paramNearbyAlertRequest = null;
        }
      }
        ...
        throws RemoteException
      {
        ...
        while (true)
        {
          ...
          localParcel1.writeInt(0);
          continue;
          label132: paramPlaceFilter = null;
        }
      }
        ...
        throws RemoteException
      {
        ...
        while (true)
        {
          ...
          localParcel1.writeInt(0);
          continue;
          label132: paramPlaceReport = null;
        }
      }
        ...
        throws RemoteException
      {
        ...
        while (true)
        {
          ...
          label150: localParcel1.writeInt(0);
          continue;
          label159: paramPlaceRequest = null;
        }
      }
        ...
        throws RemoteException
      {
        ...
        while (true)
        {
          ...
          localParcel1.writeInt(0);
          continue;
          label131: paramPlacesParams = null;
        }
      }
