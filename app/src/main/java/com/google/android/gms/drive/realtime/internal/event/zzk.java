  ...
  implements Parcelable.Creator<ValuesRemovedDetails>
{
  static void zza(ValuesRemovedDetails paramValuesRemovedDetails, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 5, zzaAI, false);
    zzb.zzc(paramParcel, 6, zzaAJ);
    zzb.zzJ(paramParcel, paramInt);
  }

  public ValuesRemovedDetails zzfB(Parcel paramParcel)
  {
    int i = 0;
  ...
  public ValuesRemovedDetails[] zzhZ(int paramInt)
  {
